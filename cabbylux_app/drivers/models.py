...
class Driver(models.Model):
    ...
    vehicle_details = models.CharField(max_length=255)  # Consider breaking this into a separate model
    ...
    account_status = models.CharField(max_length=10, choices=[('active', 'Active'), ('inactive', 'Inactive'), ('suspended', 'Suspended')])
